...
public class TelaDeCadastroModel {
    public static int cadastrarModel(String nome, String email, String senha, String caminhoFoto) {
        try {
            ...
            if (rstSqlEmail.next()) {
                ...
                String strSqlCadastrar = "insert into `db_senac`.`tbl_senac` (`nome`, `email`, `senha`, `caminho_foto`) values ('" + nome + "', '" + email + "', '" + senha + "', '" + caminhoFoto + "');";
